...
import { getHeroData } from "./[lang]/(admin)/admin/api-calls";
import { getInoNumbersData } from "./[lang]/(admin)/admin/our-industries/api-calls";
import { getAboutData } from "./[lang]/(admin)/admin/about-us/api-calls";
import { getServiceData } from "./[lang]/(admin)/admin/our-services/api-calls";
import { getClientData } from "./[lang]/(admin)/admin/our-client/api-calls";
import { HeroTypes } from "./[lang]/(admin)/admin/page";
import { NumbersInfo } from "@prisma/client";
import { AboutTypes } from "./[lang]/(admin)/admin/about-us/page";
